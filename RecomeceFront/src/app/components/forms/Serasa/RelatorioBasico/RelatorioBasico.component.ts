...
@Component({
  selector: 'app-RelatorioBasico',
  templateUrl: './RelatorioBasico.component.html',
  styleUrls: ['./RelatorioBasico.component.css', '../RelatorioAvancado/RelatorioAvancado.component.css']
})
export class RelatorioBasicoComponent implements OnInit {
  ...
  public calcDebit(): void {
    ...
    const totalDivida = negativeData.pefin.summary.balance + negativeData.refin.summary.balance + negativeData.notary.summary.balance + negativeData.check.summary.balance + negativeData.collectionRecords.summary.balance;
    const qtdDivida = negativeData.pefin.summary.count + negativeData.refin.summary.count + negativeData.notary.summary.count + negativeData.check.summary.count + negativeData.collectionRecords.summary.count;
