...
namespace RecomeceAPI.Controllers
{
  ...
  public class CidadesController : ControllerBase
  {
    ...
    public CidadesController(CidadesService service, HandleCatchService handleCatchService)
    {
      _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Save([FromBody] CidadesModel model)
    {
      try
      {
    ...
    [HttpPut]
    public async Task<IActionResult> Update([FromBody] CidadesModel model)
    {
      try
      {
    ...
    [HttpGet("GetByIbge")]
    public async Task<IActionResult> GetByIbge([FromQuery] string codigoIBGE)
    {
      try
      {
        var pagination = await _service.GetByIbgeAsync(codigoIBGE);
