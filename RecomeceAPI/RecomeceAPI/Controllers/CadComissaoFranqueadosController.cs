...
namespace RecomeceAPI.Controllers
{
  ...
  public class CadComissaoFranqueadosController : ControllerBase
  {
    private readonly CadComissaoFranqueadosService _service;
    private readonly HandleCatchService _handleCatchService;

    public CadComissaoFranqueadosController(CadComissaoFranqueadosService service, HandleCatchService handleCatchService)
    {
      _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Save([FromBody] CadComissaoFranqueadosModel model)
    {
      try
      {
    ...
    [HttpPut]
    public async Task<IActionResult> Update([FromBody] CadComissaoFranqueadosModel model)
    {
      try
      {
