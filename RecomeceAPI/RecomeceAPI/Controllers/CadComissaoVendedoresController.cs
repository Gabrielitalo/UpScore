...
namespace RecomeceAPI.Controllers
{
  ...
  public class CadComissaoVendedoresController : ControllerBase
  {
    private readonly CadComissaoVendedoresService _service;
    private readonly HandleCatchService _handleCatchService;

    public CadComissaoVendedoresController(CadComissaoVendedoresService service, HandleCatchService handleCatchService)
    {
      _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Save([FromBody] CadComissaoVendedoresModel model)
    {
      try
      {
    ...
    [HttpPut]
    public async Task<IActionResult> Update([FromBody] CadComissaoVendedoresModel model)
    {
      try
      {
