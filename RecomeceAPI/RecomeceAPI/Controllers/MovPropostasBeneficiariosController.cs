...
namespace RecomeceAPI.Controllers
{
  ...
  public class MovPropostasBeneficiariosController : ControllerBase
  {
    private readonly MovPropostasBeneficiariosService _service;
    private readonly HandleCatchService _handleCatchService;

    public MovPropostasBeneficiariosController(MovPropostasBeneficiariosService service, HandleCatchService handleCatchService)
    {
      _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Save([FromBody] MovPropostasBeneficiariosModel model)
    {
      try
      {
    ...
    [HttpPut]
    public async Task<IActionResult> Update([FromBody] MovPropostasBeneficiariosModel model)
    {
      try
      {
