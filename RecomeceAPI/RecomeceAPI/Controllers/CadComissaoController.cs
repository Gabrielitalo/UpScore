...
namespace RecomeceAPI.Controllers
{
  ...
  public class CadComissaoController : ControllerBase
  {
    private readonly CadComissaoService _service;
    private readonly HandleCatchService _handleCatchService;

    public CadComissaoController(CadComissaoService service, HandleCatchService handleCatchService)
    {
      _service = service;
    ...
    [HttpPost]
    public async Task<IActionResult> Save([FromBody] CadComissaoModel model)
    {
      try
      {
    ...
    [HttpPut]
    public async Task<IActionResult> Update([FromBody] CadComissaoModel model)
    {
      try
      {
